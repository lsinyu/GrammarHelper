...
public class PDFReportGenerator {
    ...
    public File generateReport() throws Exception {
        ...
        String fileName = "GrammarExpert_Report_" + timestamp + ".pdf";
        ...
        // ===== TITLE SECTION =====
        Paragraph title = new Paragraph("Grammar Expert - Progress Report")
                .setFont(boldFont)
                .setFontSize(24)
        ...
        addUserRow(userTable, "Report ID:", "GE-" + timestamp, regularFont);
        ...
        // ===== FOOTER =====
        document.add(new Paragraph("\n\n"));
        Paragraph footer = new Paragraph("Generated by Grammar Expert App - Keep improving your writing skills!")
                .setFont(regularFont)
                .setFontSize(9)
                .setTextAlignment(TextAlignment.CENTER)
